...
############ Temur Gugushvili ###########
############ Cross tabulation of Human Capital ###########
...
code_configurations <- readr::read_csv("data/code_configurations_1.csv")


human_capital_2 <- ggplot2::ggplot(code_configurations, aes(Human_capital, Economic_activities_general, fill= Segments)) +
                   geom_tile() +
...
ggplot2::ggsave("visualization/Fig3.JPG", 
